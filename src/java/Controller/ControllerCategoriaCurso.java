...
public class ControllerCategoriaCurso extends HttpServlet {
    ...
    public String getTableCategoriaCurso() {
        ...
        try {
            ...
            while (result.next()) {
                ...
                arreglo[2]
                        = "<a class=\"btn-sm btn-primary btn-block \" href=\"javascript:void(0)\"  onclick=\"categoriaCurso.editar("
                        + contador + ")\"><span class=\"glyphicon glyphicon-edit\"></span></a>";
                lista.add(arreglo);
                contador++;
            }
        } catch (Exception e) {
    ...
    public String getOptionsCategorias() {
        ...
        try {
            ...
            while (result.next()) {
                lista += ("<option value=\"" + result.getString("idCategoriaCurso").trim() + "\">"
                        + result.getString("nombreCategoriaCurso").trim() + "</option>");
            }
        } catch (Exception e) {
