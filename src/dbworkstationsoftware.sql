...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 23-04-2015 a las 17:56:43
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `spIngresarCliente`(IN `tipoDocumen` VARCHAR(5),
 IN `numeroDocumen` VARCHAR(15),
 IN `fechaNacimien` DATETIME,
 IN `generoClien` INT,
 IN `nombreClien` VARCHAR(50),
...
ALTER TABLE `tblcredito`
 ADD PRIMARY KEY (`idCredito`), ADD KEY `fk_tblcredito_tblcliente1_idx` (`tipoDocumento`,`numeroDocumento`), ADD KEY `numeroDocumento` (`numeroDocumento`);
...
ALTER TABLE `tblsubsidio`
 ADD PRIMARY KEY (`idSubsidio`), ADD KEY `fk_tblsubsidio_tblempresa1_idx` (`tblempresa_nitEmpresa`), ADD KEY `fk_tblsubsidio_tblcliente1_idx` (`tblcliente_tipoDocumento`,`tblcliente_numeroDocumento`), ADD KEY `tblcliente_numeroDocumento` (`tblcliente_numeroDocumento`);
...
ALTER TABLE `tblventa`
 ADD PRIMARY KEY (`idVenta`), ADD KEY `fk_tblventa_tblfactura1_idx` (`tblfactura_idFactura`), ADD KEY `fk_tblventa_tblusuario1_idx` (`tblusuario_idUsuario`), ADD KEY `fk_tblventa_tblcliente1_idx` (`tblcliente_tipoDocumento`,`tblcliente_numeroDocumento`), ADD KEY `tblcliente_numeroDocumento` (`tblcliente_numeroDocumento`);
...
--
ALTER TABLE `tblficha`
MODIFY `idFicha` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=4;
--
...
--
ALTER TABLE `tblseminario`
MODIFY `idSeminario` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=4;
--
...
ADD CONSTRAINT `tblcredito_ibfk_1` FOREIGN KEY (`tipoDocumento`) REFERENCES `tblcliente` (`tblacudiente_tipoDocumento`) ON DELETE CASCADE ON UPDATE CASCADE,
ADD CONSTRAINT `tblcredito_ibfk_2` FOREIGN KEY (`numeroDocumento`) REFERENCES `tblcliente` (`tblacudiente_numeroDocumento`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ADD CONSTRAINT `tblsubsidio_ibfk_1` FOREIGN KEY (`tblcliente_tipoDocumento`) REFERENCES `tblcliente` (`tblacudiente_tipoDocumento`) ON DELETE CASCADE ON UPDATE CASCADE,
ADD CONSTRAINT `tblsubsidio_ibfk_2` FOREIGN KEY (`tblcliente_numeroDocumento`) REFERENCES `tblcliente` (`tblacudiente_numeroDocumento`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ADD CONSTRAINT `tblventa_ibfk_1` FOREIGN KEY (`tblcliente_tipoDocumento`) REFERENCES `tblcliente` (`tblacudiente_tipoDocumento`) ON DELETE CASCADE ON UPDATE CASCADE,
ADD CONSTRAINT `tblventa_ibfk_2` FOREIGN KEY (`tblcliente_numeroDocumento`) REFERENCES `tblcliente` (`tblacudiente_numeroDocumento`) ON DELETE CASCADE ON UPDATE CASCADE;
