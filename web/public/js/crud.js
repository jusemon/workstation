    ...
    consultar: function(id) {
        $.ajax({
            ...
            success: function(data, textStatus, jqXHR) {
                ...
                $('#tabMovimientos').find('#txtFechaMovimiento').text('Fecha: ');
                $('#tabMovimientos').find('#txtNombre').val(data["Compra"]['nombreProveedor']);
                $('#tabMovimientos').find('#txtNumeroFactura').val(data["Compra"]['facturaProveedor']);
