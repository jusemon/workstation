                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">                                        
                                            <div class="form-group">
                                                Nombre
                                                <input name="txtNombre" id="txtNombreCategoriaArticulo" type="text" pattern="[ÁÉÍÓÚáéíóúñÑ°a-zA-Z ]{3,15}" title="Entre 3 y 30 letras y no se permiten números" class="form-control" placeholder="Ej: Vinilos" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
